...
gifButton.addEventListener(
    ...
    () => {
        ...
        showFeatureNotice(
            "GIF sharing isn't available in Apex Chat yet."
        );
    }
);
...
voiceCallButton.addEventListener(
    ...
    () => {
        ...
        showFeatureNotice(
            "Voice calling isn't available in Apex Chat yet."
        );
    }
);
...
conversationMoreButton.addEventListener(
    ...
    () => {
        ...
        showFeatureNotice(
            "More conversation controls are coming in a future update."
        );
    }
);
